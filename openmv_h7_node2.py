...
class openmvH7Node(Node):
    def __init__(self):
        ...
        shutil.copy("/home/rrrschuetz/ros2_ws4/src/s2e_lidar_reader/s2e_lidar_reader/h7_cam_exec.py", "/mnt/cam2/h7_cam_exec.py")
    ...
    def timer_callback(self):
        try:
            ...
            if os.path.exists("/mnt/cam2/pipe"):
                with open("/mnt/cam2/pipe", 'r') as file:
                    ...
                    if header:
                        ...
                        if len(parts) >= 4:
                            str_len = int(parts[1])
                            jpg_len = int(parts[3])
                            msg.data = file.read(str_len).decode()
